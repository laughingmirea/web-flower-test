...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		$query_p=mysqli_query($con_en,$sql_p);
...
if(isset($_POST['submit']))
{
	...
	$review=$_POST['review'];
	mysqli_query($con_en,"insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
...
<?php
$ret=mysqli_query($con_en,"select category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
...
<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
	...
	<div class="sidebar-widget-body m-t-10">
		<div class="accordion">
		            ...
		            <?php $sql=mysqli_query($con_en,"select id,categoryName  from category");
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
								   ...
								   <?php
$ret=mysqli_query($con_en,"select * from products order by rand() limit 4 ");
...
<?php 
$ret=mysqli_query($con_en,"select * from products where id='$pid'");
...
<?php $rt=mysqli_query($con_en,"select * from productreviews where productId='$pid'");
...
<?php $qry=mysqli_query($con_en,"select * from productreviews where productId='$pid'");
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con_en,"select * from products where subCategory='$subcid' and category='$cid'");
